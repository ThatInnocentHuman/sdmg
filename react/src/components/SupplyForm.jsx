...
export default function SupplyForm({
  ...
  const onSubmit = (e) => {
    ...
    if (sup.id) {
      axiosClient
        .put(`/supply${sup.id}`, sup)
        .then(() => {
          getSupplies();
          setNotification("Pemasokan berhasil diupdate");
          closeModal();
          setSup({
            id: null,
            name: "",
      ...
      axiosClient
        ...
        .then(() => {
          getSupplies();
          setNotification("Pemasokan berhasil ditambahkan");
          closeModal();
        })
        .catch((err) => {
          const response = err.response;
      ...
      >
        ...
        >
          ...
          <input
            ...
            // value={sup && sup.name}
            onChange={(ev) => {
              setSup({ ...sup, supplier_id: ev.target.value });
            }}
          />
          <label htmlFor="">No Tabung</label>
          <input
            ref={addressRef}
            type="text"
            ...
            onChange={(ev) => {
              setSup({ ...sup, tube_id: ev.target.value });
            }}
          />
